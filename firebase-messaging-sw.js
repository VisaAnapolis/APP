...
// ── Atualização imediata: não aguarda abas serem fechadas ──
// skipWaiting() faz o novo SW assumir assim que instalado,
// sem esperar que todas as abas do app sejam fechadas.
// clients.claim() garante que o SW controla imediatamente
// todas as abas já abertas.
...
messaging.onBackgroundMessage((payload) => {
  ...
  const notifUrl   = d.url   || self.registration.scope + 'index.html';
