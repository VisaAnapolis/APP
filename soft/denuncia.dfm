object frmdenuncia: Tfrmdenuncia
  ...
  object barraferra: TToolBar
    ...
    object btlocden: TSpeedButton
      Left = 75
      Top = 2
      Width = 35
      Height = 37
      Hint = 'Localiza Denúncia'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -9
      Font.Name = 'Arial'
  ...
  object GBDen: TGroupBox
    ...
    object Label8: TLabel
      ...
      Width = 137
      Height = 13
      Caption = 'Descricão detalhada  do fato'
    end
    ...
    object DBCOb1: TDBComboBox
      ...
      Items.Strings = (
        ...
        '- [ ] PRODUTOS ALIMENTÍCIOS - COMÉRCIO'
        '- [ ] PRODUTOS ALIMENTÍCIOS - FABRICAÇÃO'
        '- [ ] PRODUTOS ALIMENTÍCIOS- DISTRIBUIÇÃO '
        '- [ ] PRODUTOS COSMÉTICOS - FABRICAÇAO E DISTRIBUIÇÃO '
        '- [ ] PRODUTOS COSMÉTICOS- COMÉRCIO'
        '- [ ] PRODUTOS FARMACÊUTICOS- COMÉRCIO'
        '- [ ] PRODUTOS FARMACÊUTICOS- DISTRIBUIÇÃO '
        '- [ ] PRODUTOS FARMACÊUTICOS- MANIPULAÇÃO '
        '- [ ] PRODUTOS PARA SAÚDE - COMÉRCIO'
        '- [ ] PRODUTOS PARA SAÚDE - FABRICAÇÃO E DISTRIBUIÇÃO '
        '- [ ] PRODUTOS SANEANTES -  FABRICAÇAO E DISTRIBUIÇÃO '
        '- [ ] PRODUTOS SANEANTES- COMÉRCIO'
        '- [ ] SAÚDE AMBIENTAL'
        ...
        '- [ ] SERVIÇOS DE SAÚDE '
        '- [ ] SERVIÇOS DE SAUDE ODONTOLÓGICA '
        '- [ ] SERVIÇOS VETERINÁRIOS'
        '- [ ] TRANSPORTE')
      Sorted = True
      TabOrder = 1
      OnChange = DBCOb1Change
    end
  ...
  object pgAnexos: TPageControl
    Left = 232
    Top = 307
    Width = 464
    Height = 241
    ActivePage = tabAnexos
    TabIndex = 0
    TabOrder = 3
    object tabAnexos: TTabSheet
      Caption = 'Anexos'
      object DBGridAnexos: TDBGrid
        Left = 2
        Top = 8
        Width = 348
        Height = 173
      ...
      object PnlBotoesAnexo: TPanel
        ...
        object BtAddImg: TButton
          ...
          TabOrder = 0
          OnClick = BtAddImgClick
        end
        object BtAddPdf: TButton
          Left = 4
          Top = 52
          Width = 90
          Height = 28
          Caption = 'Adicionar PDF'
          TabOrder = 1
          OnClick = BtAddPdfClick
        end
        object BtRemAnexo: TButton
          Left = 4
          Top = 91
          Width = 90
          Height = 28
          Caption = 'Remover'
          TabOrder = 2
          OnClick = BtRemAnexoClick
        end
        object BtAbreAnexo: TButton
          Left = 4
          Top = 132
          Width = 90
          Height = 28
          Caption = 'Abrir'
          TabOrder = 3
          OnClick = BtAbreAnexoClick
        end
      end
    end
  end
  object tbdenuncia: TTable
    BeforeScroll = tbdenunciaBeforeScroll
    ...
    object tbdenunciaPonto: TStringField
      FieldName = 'Ponto'
    end
  ...
  object tbimgden: TTable
    DatabaseName = 'wcvs'
    TableName = 'IMAGEM_DEN.DB'
    Left = 584
    Top = 100
    object tbimgdenCONTROLE: TAutoIncField
      FieldName = 'CONTROLE'
      ReadOnly = True
    end
    object tbimgdenDENUNCIA: TIntegerField
      FieldName = 'DENUNCIA'
    end
    object tbimgdenARQUIVO: TStringField
      FieldName = 'ARQUIVO'
      Size = 80
    end
    object tbimgdenTIPO: TStringField
      FieldName = 'TIPO'
      Size = 5
    end
    object tbimgdenDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 60
    end
  end
  object dsimgden: TDataSource
    AutoEdit = False
    DataSet = tbimgden
    OnDataChange = dsimgdenDataChange
    Left = 560
    Top = 100
  end
  object dlgAnexo: TOpenDialog
    Filter = 
      'Imagens (*.jpg;*.jpeg;*.png)|*.jpg;*.jpeg;*.png|PDF (*.pdf)|*.pd' +
      'f|Todos|*.*'
