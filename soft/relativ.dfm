object rel_atividade: Trel_atividade
  Left = 327
  Top = 163
  Width = 1174
  Height = 697
  Caption = 'Alvar'#225's Emitidos por Atividade Econ'#244'mica'
  Color = clBtnFace
  ...
  object QRativ: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Rela'#231#227'o de Alvar'#225's Emitidos na Atividade Econ'#244'mica :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel8: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Validade do '#249'ltimo alvar'#225' '
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
