...
begin
  ...
  try
    ...
    begin
      Msg := Msg + 'CNAEs a INCLUIR na RT:' + #13#10;
    ...
    begin
      Msg := Msg + 'CNAEs a EXCLUIR da RT:' + #13#10;
...
begin
  ...
  begin
    ...
    begin
      ...
      on E: EDBEngineError do
        { Tabela SIMAUX inexistente ou inacessovel; segue para o CSV }
        ;
    end;
  end;
  ...
  try
    ...
    begin
      FSimStatus.Caption := 'API SIM: auxiliar nao encontrado';
      Exit;
    end;
    ...
    try
      ...
      { 1a busca: por inscricao a percorre todo o arquivo (auxiliar nao esta ordenado) }
      if MunAtual <> '' then
      begin
        ...
        begin
          ...
          { Nao exige SitCSV = ATIVO no auxiliar; o arquivo ja foi filtrado na geracao }
      ...
      { 2a busca: por documento, somente se nao achou inscricao }
      if (not AchouInscricao) and (DocAtual <> '') then
      begin
        CloseFile(Arq);
        AssignFile(Arq, CaminhoSIMAux);
