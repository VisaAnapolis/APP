...
type
  Trel_juntada = class(TForm)
    repjuntada: TQuickRep;
    bandatitulo: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRShape1: TQRShape;
    ...
    procedure repjuntadaBeforePrint(Sender: TCustomQuickRep;
...
procedure Trel_juntada.repjuntadaBeforePrint(Sender: TCustomQuickRep;var PrintReport: Boolean);
var
mes    :integer;
mesenc :integer;
I      :integer;
