...
begin
  ...
  begin
    ...
    FSimStatus.Left := 8;
    FSimStatus.Top := 16;
    FSimStatus.Caption := 'Sincronizaùùo com SIM: nùo disponùvel';
  ...
  begin
    ...
    FSimGrid.Height := GroupBox13.Height - 44;
...
begin
  ...
  begin
    FSimStatus.Caption := 'Sincronizaùùo com SIM: atualizando tabela...';
    Application.ProcessMessages;
...
begin
  ...
  begin
    ...
    begin
      ...
      FSimStatus.Caption :=
        'Sincronizaùùo com SIM: ' + FormatDateTime('dd/mm/yyyy hh:nn', DataAux);
      Exit;
    end;
  end;
...
begin
  ...
  begin
    FSimStatus.Caption := 'Sincronizaùùo com SIM: atualizando...';
    Application.ProcessMessages;
    GerarAuxSIM;
  end;
  ...
  try
    ...
    begin
      FSimStatus.Caption := 'Sincronizaùùo com SIM: auxiliar nùo encontrado';
      Exit;
    end;
