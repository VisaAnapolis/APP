...
procedure Trel_req.FormActivate(Sender: TObject);
begin
    QRLFiscal.Caption    := frmlogin.c_user;
end;

procedure Trel_req.BRequerimentoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
//    if tbreqprazo.IsNull then qrldias.Caption := '' else qrldias.Caption := inttostr(daysbetween(date,tbreqprazo.value));
//    if tbreq
