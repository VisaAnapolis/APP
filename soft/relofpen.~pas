...
procedure Trel_ofpen.FormActivate(Sender: TObject);
begin
    QRLFiscal.Caption    := frmlogin.c_user;
end;

procedure Trel_ofpen.BRequerimentoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
