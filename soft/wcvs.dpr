...
uses
  ...
  uHashSenha in 'uHashSenha.pas',
  ParamLogin in 'ParamLogin.pas' {frmParamLogin},
  ResetSenha in 'ResetSenha.pas' {frmResetSenha},
  ParamBairro in 'ParamBairro.pas' {frmParamBairro},
  ParamCnae in 'ParamCnae.pas' {frmParamCnae},
  ParamSequencia in 'ParamSequencia.pas' {frmParamSequencia},
  AVISOINAT in 'AVISOINAT.pas',
  r_osurg in 'r_osurg.pas' {frmosurg},
  urgencia in 'urgencia.pas' {frmurgencia};
...
begin
  ...
  Application.CreateForm(TfrmParamSequencia, frmParamSequencia);
  Application.CreateForm(Tfrmosurg, frmosurg);
  Application.CreateForm(Tfrmurgencia, frmurgencia);
  Application.Run;
end.
